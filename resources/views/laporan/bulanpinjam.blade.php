...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12 col-sm-12  ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Laporan bulan peminjaman<small>Data laporan</small></h2>
                  ...
                  <div class="x_content">
                                ...
                                <div class="col-md-6">
                            <a href="{{url('/laporan/cetakbp?bulan='.Request::get('bulan'))}}" target="_blank" class="btn btn-primary key">Cetak</a> <br><br>
