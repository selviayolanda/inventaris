...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12 col-sm-12  ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Laporan harian peminjaman<small>Data laporan</small></h2>
                  ...
                  <div class="x_content">
                            ...
                            <a href="{{url('/laporan/cetak?tanggal1='.Request::get('tanggal1').'&tanggal2='.Request::get('tanggal2'))}}" 
                            target="_blank" class="btn btn-primary key">Cetak</a> <br><br>
